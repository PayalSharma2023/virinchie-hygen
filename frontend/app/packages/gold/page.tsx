...
export default function GoldPackagePage() {
  ...
  return (
    <main className="font-sans bg-white dark:bg-slate-950 text-slate-800 dark:text-slate-100">
      ...
      {/* ── HERO ── */}
      <section className="relative overflow-hidden bg-gradient-to-br from-amber-50 via-white to-sky-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 py-10">
        <div className="absolute top-0 right-0 w-96 h-96 bg-amber-100/40 dark:bg-amber-900/10 rounded-full blur-[120px] pointer-events-none" />
        <div className="absolute bottom-0 left-10 w-64 h-64 bg-sky-100/40 dark:bg-sky-900/10 rounded-full blur-[80px] pointer-events-none" />
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -top-20 -right-20 w-[500px] h-[500px] border border-amber-100 dark:border-amber-900/20 rounded-full" />
          <div className="absolute -top-10 -right-10 w-[400px] h-[400px] border border-amber-100 dark:border-amber-900/20 rounded-full" />
        </div>
        ...
        <div className="relative max-w-6xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <span className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-amber-700 dark:text-amber-400 bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-700/50 px-4 py-1.5 rounded-full mb-6 shadow-sm">
              ...
              <h1 className="text-5xl lg:text-6xl font-bold text-slate-800 dark:text-white mb-4 leading-tight" style={{ fontFamily: "'Georgia', serif" }}>
                Gold
                <span className="block text-2xl font-normal text-slate-400 dark:text-slate-500 mt-1 tracking-wide" style={{ fontFamily: "sans-serif" }}>Premium Construction</span>
              </h1>
              ...
              <div className="flex items-baseline gap-3 mb-8">
                <span className="text-5xl font-bold text-amber-600 dark:text-amber-400" style={{ fontFamily: "'Georgia', serif" }}>₹1,999</span>
              ...
              <div className="flex flex-wrap gap-2 mb-10">
                {["5-year warranty", "Within 25 km radius", "Rainwater harvesting", "HVAC provisions"].map((b) => (
                  <span key={b} className="inline-flex items-center gap-1.5 text-xs font-semibold text-amber-800 dark:text-amber-300 bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-700/50 px-3 py-1.5 rounded-full">
                    <svg className="w-3.5 h-3.5 text-amber-500 dark:text-amber-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
            ...
            <div className="relative">
              <div className="bg-white dark:bg-slate-800/80 rounded-2xl border border-amber-100 dark:border-amber-900/30 shadow-xl shadow-amber-100/60 dark:shadow-black/40 p-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={item.label} className="bg-amber-50/60 dark:bg-amber-900/20 rounded-xl p-4">
                      <p className="text-xs text-amber-700/60 dark:text-amber-400/70 uppercase tracking-wider font-medium mb-1">{item.label}</p>
      ...
      <section className="py-20 bg-white dark:bg-slate-950">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            <span className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-amber-700 dark:text-amber-400 bg-amber-50 dark:bg-amber-900/30 border border-amber-100 dark:border-amber-800/40 px-4 py-1.5 rounded-full mb-4">
            ...
            {specs.map((sec, i) => (
              <div key={i} className="rounded-2xl border border-slate-100 dark:border-slate-800 overflow-hidden shadow-sm hover:shadow-md dark:hover:shadow-black/30 transition-shadow duration-200">
                <button
                  ...
                  className="w-full flex items-center justify-between px-6 py-5 text-left bg-white dark:bg-slate-900 hover:bg-amber-50/30 dark:hover:bg-slate-800/60 transition-colors duration-150"
                >
                  <div className="flex items-center gap-3">
                    <span className="text-amber-600 dark:text-amber-400">{sec.icon}</span>
                    <span className="font-semibold text-slate-800 dark:text-slate-100">{sec.category}</span>
                  </div>
                  <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all duration-300 ${openSection === i ? "bg-amber-500 border-amber-500 rotate-45" : "border-slate-200 dark:border-slate-600"}`}>
                ...
                <div className={`overflow-hidden transition-all duration-300 ${openSection === i ? "max-h-96" : "max-h-0"}`}>
                  <div className="px-6 pb-5 bg-amber-50/20 dark:bg-slate-800/40">
                    <div className="pt-2 grid sm:grid-cols-2 gap-2">
                      {sec.items.map((item, j) => (
                        <div key={j} className="flex items-start gap-3 bg-white dark:bg-slate-800 rounded-xl p-3.5 border border-slate-100 dark:border-slate-700">
                          <svg className="w-4 h-4 text-amber-500 dark:text-amber-400 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 12.75 6 6 9-13.5" />
                          </svg>
                          <div>
          ...
          <div className="bg-white dark:bg-slate-800/80 rounded-2xl border border-sky-100 dark:border-sky-800/40 shadow-lg dark:shadow-black/30 overflow-hidden">
            ...
            <div className="p-8 flex flex-col sm:flex-row items-start sm:items-center gap-6">
              <div className="flex-1">
                <p className="text-xs font-bold uppercase tracking-widest text-[#01589e] dark:text-sky-400 mb-1">Luxury Upgrade</p>
                <h3 className="text-xl font-bold text-slate-800 dark:text-white mb-2" style={{ fontFamily: "'Georgia', serif" }}>Upgrade to Platinum for +₹700/sq.ft</h3>
                <div className="flex flex-wrap gap-2">
                  {["Premium marble / granite flooring", "Luxury bathroom fittings", "Designer false ceiling", "Smart home provisions", "10-year structural warranty"].map((b) => (
              ...
              <Link href="/packages/platinum" className="flex-shrink-0 group inline-flex items-center gap-2 bg-[#210568] text-white px-5 py-3 rounded-xl text-sm font-semibold hover:bg-[#01589e] transition-all duration-200 hover:-translate-y-0.5 shadow-md shadow-blue-900/20">
                See Platinum
