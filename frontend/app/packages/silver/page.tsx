...
const upgrades = [
  { from: "Silver", to: "Gold", diff: "+₹400/sq.ft", benefits: ["Fe500 steel", "AAC blocks", "UPVC windows", "Havells electricals", "5-yr warranty"] },
];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h1 className="text-5xl lg:text-6xl font-bold text-slate-800 mb-4 leading-tight" style={{ fontFamily: "'Georgia', serif" }}>
                Silver
                <span className="block text-2xl font-normal text-slate-400 mt-1 tracking-wide" style={{ fontFamily: "sans-serif" }}>Essential Construction</span>
              </h1>
              ...
              <div className="flex items-baseline gap-3 mb-8">
                <span className="text-5xl font-bold text-[#210568]" style={{ fontFamily: "'Georgia', serif" }}>₹1,599</span>
              ...
              <div className="flex flex-wrap gap-2 mb-10">
                {["3-year warranty", "Within 25 km radius", "Customizable"].map((b) => (
                  <span key={b} className="inline-flex items-center gap-1.5 text-xs font-semibold text-slate-600 bg-slate-50 border border-slate-200 px-3 py-1.5 rounded-full">
            ...
            {specs.map((sec, i) => (
              <div key={i} className="rounded-2xl border border-slate-100 overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-200">
                ...
                >
                  ...
                  <div className={`w-6 h-6 rounded-full border-2 border-slate-200 flex items-center justify-center transition-all duration-300 ${openSection === i ? "bg-[#210568] border-[#210568] rotate-45" : ""}`}>
          ...
          <div className="bg-white rounded-2xl border border-sky-100 shadow-lg overflow-hidden">
            ...
            <div className="p-8 flex flex-col sm:flex-row items-start sm:items-center gap-6">
              <div className="flex-1">
                <p className="text-xs font-bold uppercase tracking-widest text-[#01589e] mb-1">Upgrade Available</p>
                <h3 className="text-xl font-bold text-slate-800 mb-2" style={{ fontFamily: "'Georgia', serif" }}>Step up to Gold for +₹400/sq.ft</h3>
                <div className="flex flex-wrap gap-2">
                  {["Fe500 steel", "AAC blocks", "UPVC windows", "Havells electricals", "5-yr warranty"].map((b) => (
                    <span key={b} className="text-xs bg-sky-50 text-sky-700 border border-sky-100 px-2.5 py-1 rounded-full font-medium">{b}</span>
                  ))}
                </div>
              </div>
