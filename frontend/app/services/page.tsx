...
const services = [
  {
    hash: "hydrology", title: "Hydrological Modeling", category: "Hydrology",
  ...
  {
    hash: "environmental-eia", title: "Environmental Consultancy", category: "Environment",
  ...
  {
    hash: "architecture-interior", title: "Building Information Modeling (BIM)", category: "BIM",
    ...
    points: ["3D parametric modeling for architecture, structure & MEP","Clash detection & interdisciplinary coordination","4D scheduling & 5D cost estimation","As-built modeling & facility management support"],
    link: "/services/bim",
    color: "from-cyan-400 to-blue-500",
    bg: "bg-cyan-50 dark:bg-cyan-950/40",
    border: "border-cyan-100 dark:border-cyan-800/50",
    text: "text-cyan-600 dark:text-cyan-400",
    icon: (<svg viewBox="0 0 24 24" fill="none" className="w-6 h-6" stroke="currentColor" strokeWidth={1.8}><path strokeLinecap="round" strokeLinejoin="round" d="M3 10h3l3 8h8l3-8h3" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 3v7m0 4v1" /><path strokeLinecap="round" strokeLinejoin="round" d="M8 14h8" /></svg>),
  },
  {
    hash: "water-infrastructure", title: "Infrastructure & Structural Design", category: "Civil",
  ...
  {
    hash: "dpr-project-reports", title: "Water Supply & Wastewater", category: "Water",
  ...
  {
    hash: "waste", title: "Solid Waste Management", category: "Waste",
  ...
  {
    hash: "energy", title: "Renewable Energy Solutions", category: "Energy",
  ...
  {
    hash: "project-management", title: "Project Management & Consultancy", category: "PMC",
  ...
  {
    hash: "survey-gis", title: "GIS & Remote Sensing", category: "GIS",
  ...
  {
    hash: "cad-support", title: "Custom Engineering Solutions", category: "Custom",
...
export default function ServicesPage() {
  ...
  return (
    <>
      {/* ── HERO ── */}
      <section className="relative min-h-[60vh] flex items-center overflow-hidden bg-[#f0f7ff] dark:bg-slate-950">
        <div className="absolute inset-0">
          <Image src="/services.jpg" alt="Engineering Services" fill priority className="object-cover brightness-105 saturate-75 dark:brightness-50 dark:saturate-50" />
        ...
        <div className="absolute top-10 right-10 w-80 h-80 bg-sky-200/30 dark:bg-sky-900/20 rounded-full blur-[100px] pointer-events-none" />
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-20">
          ...
          <Reveal>
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-slate-800 dark:text-white leading-tight mb-5" style={{ fontFamily: "'Georgia', serif", letterSpacing: "-0.02em" }}>
              Our Engineering{" "}
              <span className="relative inline-block">
                <span className="text-sky-500 dark:text-sky-400">Services</span>
      ...
      {/* ── SERVICES GRID ── */}
      <section className="relative py-24 bg-gradient-to-b from-white to-sky-50/30 dark:from-slate-950 dark:to-slate-900 overflow-hidden">
        <div className="absolute top-0 right-0 w-[350px] h-[350px] bg-sky-100/40 dark:bg-sky-900/10 rounded-full blur-[100px] pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-[350px] h-[350px] bg-teal-100/40 dark:bg-teal-900/10 rounded-full blur-[100px] pointer-events-none" />

        <div className="relative max-w-6xl mx-auto px-6">
          <Reveal>
            <div className="text-center mb-10">
              <span className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-sky-500 dark:text-sky-400 bg-sky-50 dark:bg-sky-900/30 border border-sky-100 dark:border-sky-800/50 px-4 py-1.5 rounded-full mb-5">
                <span className="w-1.5 h-1.5 rounded-full bg-sky-400" />Our Expertise
              </span>
              <h2 className="text-3xl md:text-4xl font-bold text-slate-800 dark:text-white mb-3" style={{ fontFamily: "'Georgia', serif" }}>
                Explore Our{" "}
                <span className="relative inline-block">
                  <span className="text-sky-500 dark:text-sky-400">Capabilities</span>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {filtered.map((s, i) => (
              <Reveal key={s.title} delay={i * 60}>
                <div id={s.hash} style={{ scrollMarginTop: "88px" }}
                  className={`group relative ${s.bg} border ${s.border} rounded-2xl p-7 hover:shadow-xl dark:hover:shadow-black/40 hover:-translate-y-1.5 transition-all duration-300 overflow-hidden h-full flex flex-col`}>
                  ...
                  <div className="flex items-center justify-between mb-5 relative">
                    <div className={`inline-flex items-center justify-center w-12 h-12 rounded-xl bg-white dark:bg-slate-800 shadow-sm ${s.text} group-hover:scale-110 transition-transform duration-300`}>
                      {s.icon}
                    </div>
                    <span className={`text-[10px] font-bold uppercase tracking-widest ${s.text} bg-white dark:bg-slate-800 border ${s.border} px-2.5 py-1 rounded-full`}>
                      {s.category}
                    </span>
                  </div>
                  <h3 className="text-base font-bold text-slate-800 dark:text-white mb-2 leading-snug">{s.title}</h3>
      ...
      <section className="py-20 px-6 bg-white dark:bg-slate-950">
        <Reveal>
          <div className="relative max-w-3xl mx-auto bg-gradient-to-br from-sky-50 to-teal-50 dark:from-slate-900 dark:to-slate-800 border border-sky-100 dark:border-sky-800/40 rounded-3xl p-12 text-center overflow-hidden shadow-xl shadow-sky-100/50 dark:shadow-black/30">
            ...
            <div className="absolute -bottom-16 -left-16 w-48 h-48 bg-teal-200/40 dark:bg-teal-900/20 rounded-full blur-[60px] pointer-events-none" />
            <div className="relative">
              <span className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-sky-500 dark:text-sky-400 bg-white dark:bg-slate-800 border border-sky-100 dark:border-sky-700 px-4 py-1.5 rounded-full mb-6 shadow-sm">
                <span className="w-1.5 h-1.5 rounded-full bg-sky-400 animate-pulse" />Work With Us
              </span>
              <h2 className="text-3xl md:text-4xl font-bold text-slate-800 dark:text-white mb-4 leading-tight" style={{ fontFamily: "'Georgia', serif" }}>
                Need Expert <span className="text-sky-500 dark:text-sky-400">Engineering</span> Solutions?
              </h2>
              ...
              <div className="flex flex-wrap justify-center gap-6 text-sm text-slate-400 dark:text-slate-500">
                <a href="tel:+917018167926" className="flex items-center gap-1.5 hover:text-sky-500 dark:hover:text-sky-400 transition-colors">
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25Z" /></svg>
                  +91 7018167926
                </a>
                <a href="mailto:info@virinchiehygen.com" className="flex items-center gap-1.5 hover:text-sky-500 dark:hover:text-sky-400 transition-colors">
