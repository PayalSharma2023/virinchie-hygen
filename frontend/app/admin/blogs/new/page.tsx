      ...
      <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleInputChange}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none"
                placeholder="ai, productivity, tips (comma-separated)"
              />
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-4">
          <button
            ...
            className="flex-1 bg-primary-600 bg-black text-white py-3 px-6 rounded-lg font-semibold hover:bg-primary-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
