...
const jobs: Job[] = [
  {
    ...
    icon: (<svg viewBox="0 0 24 24" fill="none" className="w-5 h-5" stroke="currentColor" strokeWidth={1.8}><path strokeLinecap="round" strokeLinejoin="round" d="M15.362 5.214A8.252 8.252 0 0 1 12 21 8.25 8.25 0 0 1 6.038 7.047 8.287 8.287 0 0 0 9 9.601a8.983 8.983 0 0 1 3.361-6.867 8.21 8.21 0 0 0 3 2.48Z" /></svg>),
  },
  {
    id: 2, title: "GIS Analyst", location: "Remote / Hybrid", type: "Full Time", experience: "1–3 Years", category: "GIS",
  ...
  {
    id: 3, title: "Structural Design Engineer", location: "Chandigarh, India", type: "Full Time", experience: "3–6 Years", category: "Civil",
  ...
  {
    id: 4, title: "Environmental Consultant", location: "Shimla, Himachal Pradesh", type: "Full Time", experience: "2–4 Years", category: "Environment",
    color: "from-teal-400 to-emerald-400",
    bg: "bg-teal-50 dark:bg-teal-950/40",
    border: "border-teal-100 dark:border-teal-800/50",
    text: "text-teal-600 dark:text-teal-400",
    icon: (<svg viewBox="0 0 24 24" fill="none" className="w-5 h-5" stroke="currentColor" strokeWidth={1.8}><path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 0 0 8.716-6.747M12 21a9.004 9.004 0 0 1-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3" /></svg>),
  },
  {
    id: 5, title: "Project Management Consultant", location: "Delhi / Hybrid", type: "Full Time", experience: "4–8 Years", category: "PMC",
  ...
  {
    id: 6, title: "Water Resources Engineer", location: "Shimla / Delhi", type: "Full Time", experience: "2–5 Years", category: "Water",
...
export default function JobsPage() {
  ...
  return (
    <div className="bg-white dark:bg-slate-950 text-slate-800 dark:text-slate-100">
      ...
      {/* ── HERO ── */}
      <section className="relative py-24 bg-gradient-to-br from-sky-50 via-white to-teal-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-6 text-center">
          ...
          <span className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-sky-600 dark:text-sky-400 bg-white/80 dark:bg-slate-800/80 border border-sky-100 dark:border-sky-700 px-4 py-1.5 rounded-full mb-8 shadow-sm">
            <span className="w-1.5 h-1.5 rounded-full bg-sky-400 animate-pulse" />We're Hiring
          </span>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-800 dark:text-white leading-tight mb-5" style={{ fontFamily: "'Georgia', serif", letterSpacing: "-0.02em" }}>
            ...
            <span className="relative inline-block">
              <span className="text-sky-500 dark:text-sky-400">Team</span>
        ...
        <div className="max-w-5xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-6">
          {perks.map((p, i) => (
            <div key={i} className="text-center">
              <div className="w-10 h-10 bg-sky-50 dark:bg-sky-900/30 border border-sky-100 dark:border-sky-800/50 rounded-xl flex items-center justify-center mx-auto mb-3">
                <span className="text-sky-500 dark:text-sky-400 font-bold text-sm">{String(i + 1).padStart(2, "0")}</span>
              </div>
              <p className="text-sm font-bold text-slate-800 dark:text-white mb-1">{p.label}</p>
      ...
      <section className="relative py-24 bg-gradient-to-b from-white to-sky-50/30 dark:from-slate-950 dark:to-slate-900 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-[300px] h-[300px] bg-teal-100/30 dark:bg-teal-900/10 rounded-full blur-[100px] pointer-events-none" />
        ...
        <div className="relative max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            <span className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-sky-500 dark:text-sky-400 bg-sky-50 dark:bg-sky-900/30 border border-sky-100 dark:border-sky-800/50 px-4 py-1.5 rounded-full mb-4">
              <span className="w-1.5 h-1.5 rounded-full bg-sky-400" />Open Positions
            </span>
            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 dark:text-white" style={{ fontFamily: "'Georgia', serif" }}>
              Current{" "}
              <span className="relative inline-block">
                <span className="text-sky-500 dark:text-sky-400">Openings</span>
            ...
            {jobs.map((job) => (
              <div key={job.id}
                ...
                <div className="flex items-center justify-between mb-4 relative">
                  ...
                  <span className={`text-[10px] font-bold uppercase tracking-widest ${job.text} bg-white dark:bg-slate-800 border ${job.border} px-2.5 py-1 rounded-full`}>
                    {job.category}
                  </span>
                </div>
      ...
      <section className="py-20 px-6 bg-white dark:bg-slate-950">
        <div className="relative max-w-3xl mx-auto bg-gradient-to-br from-[#0c3547] via-[#01589e] to-[#0e7ab5] rounded-3xl p-12 text-center overflow-hidden shadow-xl dark:shadow-black/40">
          ...
          <div className="relative">
            <span className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-sky-300 bg-white/10 border border-white/20 px-4 py-1.5 rounded-full mb-6">
              <span className="w-1.5 h-1.5 rounded-full bg-sky-300 animate-pulse" />Open Application
            </span>
            ...
            <a href="mailto:careers@virinchiehygen.com"
